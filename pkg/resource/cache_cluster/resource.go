...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.CacheClusterID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["cacheClusterID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: cacheClusterID"))
	}
	r.ko.Spec.CacheClusterID = &tmp
