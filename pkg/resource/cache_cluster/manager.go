...
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=cacheclusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=cacheclusters/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"PreferredAvailabilityZone"}
...
func (rm *resourceManager) incompleteLateInitialization(
	...
	if ko.Spec.PreferredAvailabilityZone == nil {
		return true
	}
	return false
}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.PreferredAvailabilityZone != nil && latestKo.Spec.PreferredAvailabilityZone == nil {
		latestKo.Spec.PreferredAvailabilityZone = observedKo.Spec.PreferredAvailabilityZone
	}
