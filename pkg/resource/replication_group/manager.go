...
var lateInitializeFieldNames = []string{"CacheParameterGroupName", "Durability"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.Durability != nil && latestKo.Spec.Durability == nil {
		latestKo.Spec.Durability = observedKo.Spec.Durability
	}
