...
const (
	FinalizerString = "finalizers.elasticache.services.k8s.aws/ServerlessCacheSnapshot"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("serverlesscachesnapshots")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ServerlessCacheSnapshot{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ServerlessCacheSnapshot),
	}
}
