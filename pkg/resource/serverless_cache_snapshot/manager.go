...
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=serverlesscachesnapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=serverlesscachesnapshots/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	statusCandidates := []string{"available", "create_failed"}
