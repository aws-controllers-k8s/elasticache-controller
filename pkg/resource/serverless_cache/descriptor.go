...
const (
	FinalizerString = "finalizers.elasticache.services.k8s.aws/ServerlessCache"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("serverlesscaches")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ServerlessCache{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ServerlessCache),
	}
}
