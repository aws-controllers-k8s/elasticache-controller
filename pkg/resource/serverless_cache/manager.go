...
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=serverlesscaches,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=elasticache.services.k8s.aws,resources=serverlesscaches/status,verbs=get;update;patch
