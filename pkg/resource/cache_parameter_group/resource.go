...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["cacheParameterGroupName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: cacheParameterGroupName"))
	}
	r.ko.Spec.CacheParameterGroupName = &tmp
