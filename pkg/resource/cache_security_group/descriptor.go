...
const (
	FinalizerString = "finalizers.elasticache.services.k8s.aws/CacheSecurityGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("cachesecuritygroups")
	GroupKind            = metav1.GroupKind{
		Group: "elasticache.services.k8s.aws",
		Kind:  "CacheSecurityGroup",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CacheSecurityGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CacheSecurityGroup),
	}
}
