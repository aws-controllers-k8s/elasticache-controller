...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.UserGroupID = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	tmp, ok := fields["userGroupID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: userGroupID"))
	}
	r.ko.Spec.UserGroupID = &tmp
